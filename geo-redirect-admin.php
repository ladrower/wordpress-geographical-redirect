...
function geo_redirect_save(){
	...
	$only_outsite 	    = isset($_POST['only_outsite']) ? intval($_POST['only_outsite']) : null;
    $only_root 	        = isset($_POST['only_root']) ? intval($_POST['only_root']) : null;
    $only_once          = isset($_POST['only_once']) ? intval($_POST['only_once']) : null;
